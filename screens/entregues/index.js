...
function Entregues() {
    ...
    const [pedidos, setPedidos] = useState([{ "id": "default", "data": { "dataHora": Date.now(), "produtos": carrinho, "user": "default" } }])
            ...
            <View className="space-y-8">
                <View className="mt-16 flex items-center w-[90%] space-y-4">
                    ...
                    <Text className="text-gray-700 text-base">
                        Todas as entregas do dia foram concluídas com sucesso. Agradecemos pelo seu excelente trabalho!                    </Text>
                </View>
